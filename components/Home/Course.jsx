    ...
    <section className="my-8" style={{ backgroundColor: "#f1f1f1" }}>
      ...
      <div className="w-10/12 mx-auto mt-8 sm:grid grid-cols-3 gap-3 hidden sm:block">
        {course.map((courses) => (
          <>
            <a href={courses.url}>
              <div
                className=" my-5 shadow-xl border border-gray-200 rounded"
              ...
              >
                <div className="rounded">
                  ...
                  <p className="px-3 text-center" style={{ fontSize: "10px" }}>
                    {courses.review}
                  </p>
                  <p
      ...
      <div className="text-center mt-8">
        <a href="https://courses.microdegree.work/pages/premium-courses">
          <a
            className="text-center px-3 py-3 shadow-xl rounded text-gray-100 font-semibold mt-3 sm:px-3 py-3 text-lg shadow-xl"
