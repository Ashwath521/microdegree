...
// import AboutUs from "../components/About us/About.js";

const Footer = () => {
  return (
    <section
      className="mt-10 bg-white-100  shadow"
      style={{ boxShadow: "2px 2px 15px #000000" }}
    >
      <div className="w-10/12 mx-auto sm:grid grid-cols-4 gap-1">
        <div
          className="my-5   py-5"
          style={{ textAlign: "start", color: "#062A42" }}
        >
          <h1
            className="text-2xl uppercase"
            style={{ fontWeight: "bold", color: "#062A42" }}
          >
            Company
          </h1>
          <div className="my-5">
        ...
        >
          ...
          <div className="my-5">
            ...
            <h1 className="py-2 text-xl">
              <a
                href="https://courses.microdegree.work/pages/free"
                style={{ textDecoration: "none" }}
                target="_blank"
              >
                Free Courses
      ...
      <div style={{ textAlign: "center", width: "100%", marginTop: "-30px" }}>
        <center>
          {" "}
          <img src="/unnamed.png" alt="logo" width={400} height={150} />
        </center>
        <h6 style={{ color: "#000", fontSize: "12px", paddingBottom: "6px" }}>
